		...
		<li>
			...
			<div class="caption center-align">
				<h1 class="grey-text text-lighten-3 s1">Tu taller ideal</h3>
					...
					<a href="../../views/public/cita.php"
						class="btn btn-large white black-text waves-effect waves-grey">AGENDAR CITA</a>
			</div>
		</li>
		<li>
			<!-- random image -->
...
<div class="row">
	<div class="col s12 m4">
		<div class="icon-block">
			...
			<h6 class="light">Nos caracterizamos por hacer la reparación de tu vehiculo en el menor tiempo posible.
				obviamente cuidando cada detalle de manera que tu vehiculo este en buenas condiciones y puedas disfrutar
				de el.</h6>
		</div>
	</div>
	<!--Informacion relevante-->
...
<div class="fixed-action-btn">
	<a class="btn-floating btn-large green"
		href="https://wa.me/50370320267?text=Hola%20,%20buenos%20d%C3%ADas%20necesito%20m%C3%A1s%20informaci%C3%B3n">
