...
<div class="container">
    <div class="row">
        ...
        <h5>Su contraseña debe como mínimo ocho caracteres entre
            alfanuméricos y especiales (al menos uno de cada uno) y que sea diferente al nombre de usuario</h5>
