...
class Usuarios extends Validator
{
    ...
    */
    ...
    {
        $sql = 'SELECT id_usuario, nombres_u, apellidos, email_u, alias_u
                FROM usuarios
                WHERE id_usuario = ?';
    ...
    */
    ...
    {
        $sql = 'SELECT id_usuario, nombres_u, contrasena, dui_u, tipo_usuario, email_u, alias_u, apellidos, sueldo, telefono_u, estado, especialidad
