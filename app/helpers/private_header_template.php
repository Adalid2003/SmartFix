    ...
    */
    public static function headerTemplate($title)
    {
        ...
        if (isset($_SESSION['id_usuario'])) {
            ...
            if ($filename != 'index.php' && $filename != 'register.php' && $filename != 'recuperar.php') {
                ...
                <!--Inicio Navabar--> 
                 ...
                 <ul class="sidenav" id="mobile-sidenav">
                     ...
                     <li><a class="subheader">Mantenimientos</a></li>
                         ...
                         <li><a href="../../views/dashboard/modelo.php"><i class="material-icons">book</i>Modelos Automoviles</a></li>
                         ...
                         <li><a href="../../views/dashboard/historial.php"><i class="material-icons">history</i>Historial de sesiones</a></li>
            ...
            && $filename != 'cambiar_contra.php' && $filename != 'recuperar.php'
